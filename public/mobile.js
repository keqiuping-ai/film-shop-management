...
function salesLocalizedHtml(html) {
  if (lang !== 'en') return html;
  const phrases = {
    '业务员管理中心':'Field Sales Center','客户 · 计划 · 拜访 · 总结':'Customers · Plans · Visits · Reports',
    '标准业务流程':'Standard Sales Workflow','6 个连续步骤':'6 connected steps','建立客户资料':'Create customer profile',
    '记录门店、联系人与业务机会':'Store contacts and sales opportunities','安排拜访计划':'Schedule a visit',
    '选择客户、日期、顺序和时间':'Choose customer, date, sequence, and time','到店并记录证据':'Check in and capture evidence',
    '保存现场照片、时间和 GPS':'Save photos, time, and GPS','沟通与现场订单':'Discuss and create an order',
    '记录需求、样品、价格与收款':'Capture needs, samples, pricing, and payment','创建下一次跟进':'Schedule the next follow-up',
    '设置回访、收款或测试提醒':'Set visit, payment, or trial reminders','自动汇总工作日报':'Generate the daily report',
    '用正式业务记录形成当日总结':'Summarize the day from verified records','常用功能':'Quick Actions','点击进入独立页面':'Open a dedicated page',
    '新增客户':'Add Customer','录入新客户资料':'Create a customer profile','客户列表':'Customers','查看全部共享客户':'View all shared customers',
    '今日拜访':'Today\'s Visits','今天计划与进行中':'Today\'s plan and visits','计划拜访':'Plan Visits','选择客户并安排时间':'Choose customers and schedule time',
    '工作日报':'Daily Report','记录今天完成事项':'Record today\'s completed work','附近客户':'Nearby Customers','洛杉矶 / 拉斯维加斯':'Los Angeles / Las Vegas',
    '今日概览':'Today at a Glance','只显示数量':'Counts only','已经完成':'Completed','待跟进':'Follow-ups Due','等待拜访':'Awaiting Visit',
    '返回业务首页':'Back to Sales Home','查看资料':'View Profile','加入拜访计划':'Add to Visit Plan','已选择':'Selected',
    '安排拜访客户':'Customers to Visit','公司共享客户':'Shared Company Customers','所有业务员均可查看和拜访':'Visible to all authorized sales staff',
    '搜索名称、地址、电话或联系人':'Search name, address, phone, or contact','全部客户':'All Customers','距离⌄':'Distance⌄','＋ 新增':'＋ New','10 mi 内':'Within 10 mi','未拜访⌄':'Not Visited⌄',
    '还没有共享客户':'No shared customers yet','已经选择 ':'Selected ',' 位客户':' customers','下一步：安排顺序和时间':'Next: Schedule Route and Time',
    '客户基本资料':'Customer Details','也可以手动填写':'Manual entry is also available','客户或门店名称 *':'Customer or Store Name *','客户地址 *':'Customer Address *',
    '现场定位':'On-site Location','已到客户门口？获取当前位置':'At the customer location? Get GPS','联系电话':'Phone','电子邮箱':'Email','客户类型':'Customer Type',
    '客户来源':'Lead Source','客户备注':'Customer Notes','保存到客户列表':'Save Customer','安排顺序和时间':'Route and Schedule',
    '拜访路线':'Visit Route','计划日期':'Visit Date','开始时间':'Start Time','预计停留':'Estimated Duration','计划到店':'Planned Arrival',
    '确认并保存拜访计划':'Save Visit Plan','请先选择客户':'Select customers first','下一位客户':'Next Customer','准备出发':'Start Trip','已到店 · 拍照打卡':'Arrived · Photo Check-in',
    '继续拜访':'Continue Visit','今天还没有拜访计划，请先到“计划拜访”安排。':'No visits scheduled today. Use Plan Visits to create one.',
    '拜访执行':'Visit Workspace','已到店':'Arrived','到店打卡已完成':'Arrival verified','GPS 位置与客户地址匹配 · 门头照片已上传':'GPS matches the customer address · Storefront photo uploaded',
    '现场照片':'On-site Photos','门店、样品和陈列照片':'Store, samples, and displays','沟通记录':'Conversation Notes','录音转文字并由 AI 总结':'Transcribe audio and create an AI summary',
    '样品 / 放货':'Samples / Consignment','记录型号、数量和约定价格':'Record model, quantity, and agreed price','现场订单':'On-site Order','直接建立客户销售订单':'Create a customer sales order',
    '客户签收':'Customer Acceptance','英文签收单和手写签名':'English receipt and signature','下次跟进':'Next Follow-up','设置日期、原因和收款提醒':'Set date, reason, and payment reminder',
    '完成本次拜访':'Complete Visit','完成拜访':'Complete Visit','跟进方式':'Follow-up Method','任务类型':'Task Type','跟进时间':'Follow-up Time','跟进原因':'Reason',
    '保存跟进任务':'Save Follow-up','取消':'Cancel','创建现场订单':'Create Order','订单类型':'Order Type','出货仓库':'Fulfillment Warehouse','产品 SKU':'Product SKU',
    '成交单价':'Unit Price','本次已收':'Amount Paid','余款到期日':'Balance Due Date','付款方式':'Payment Method','可选可填':'Optional',
    '门头照片':'Storefront Photo','证明业务员已到达客户门店':'Verifies arrival at the customer location','继续拍照':'Take Photo',
    '照片时间和现场 GPS 位置已保存':'Photo time and on-site GPS saved','店内环境':'Store Interior','记录门店规模、施工区和陈列情况':'Document store size, installation bays, and displays',
    '拍摄店内':'Photograph Interior','产品 / 样品':'Products / Samples','记录展示样品及客户感兴趣的产品':'Document samples and products of interest','添加照片':'Add Photo','保存照片并返回拜访':'Save Photos and Return',
    '现场会议纪要':'On-site Meeting Notes','回顾会议':'Review Recording','继续记录':'Continue Recording','会议文字记录':'Meeting Transcript','自动转写':'Auto Transcription',
    '录音后自动生成会议文字记录':'A transcript will be generated after recording','AI 中文分析':'AI Analysis','可修改':'Editable','客户需求':'Customer Needs',
    '客户希望测试的产品和采购需求':'Products to test and purchasing needs','本次结果':'Outcome','本次沟通达成的结果':'Result of this conversation','价格反馈':'Pricing Feedback',
    '价格接受程度和反馈':'Pricing acceptance and feedback','客户异议':'Customer Concerns','客户关注和异议':'Questions and objections','后续行动计划':'Next action plan',
    '人工补充':'Additional Notes','补充会议中需要记录的重要信息……':'Add other important meeting notes…','确认并保存沟通记录':'Save Conversation Notes',
    '资料完成情况':'Visit Record Status','全部完成':'Complete','会议纪要':'Meeting Notes','收款提醒':'Payment Reminder','AI 拜访总结':'AI Visit Summary',
    'AI 总结可修改':'AI summary can be edited','完成拜访并前往下一家':'Complete Visit and Continue','本次拜访':'Current Visit','必拍':'Required','选填':'Optional',
    '保存订单后自动生成':'Generated after saving the order','确认签收并生成英文签收单':'Confirm Receipt and Generate English Form',
    '签名、签收时间、GPS 位置、产品和欠款信息将一并保存。':'Signature, receipt time, GPS, products, and balance due will be saved together.',
    '今日工作总结':'Today\'s Summary','家已完成':' completed','客户拜访':'Customer Visits','今日收款':'Payments Collected','新增跟进任务':'New Follow-ups',
    'AI 工作总结':'AI Work Summary','客户问题／需要公司协助':'Customer Issues / Company Support Needed','确认并提交今日工作日报':'Submit Daily Report',
    '所有数字来自当天正式业务记录，AI 只负责整理总结。':'All figures come from today\'s verified business records; AI only organizes the summary.',
    '当前位置周边客户':'Customers Near Current Location','GPS 已定位':'GPS Located','请先更新位置':'Update location first','更新位置':'Refresh Location','还没有客户':'No customers yet',
    '当前账号没有业务员管理权限。':'This account does not have Field Sales access.',
    '联系人：':'Contact: ','尚未填写联系人':'No contact entered','城市':'City','联系人':'Contact',
    '📷 拍照，AI 自动识别':'📷 Photograph and Auto-fill','识别店名、地址、电话和邮箱，并自动填入下方':'Recognize the store name, address, phone, and email and fill them below',
    '贴膜门店':'Film Shop','汽车改色店':'Vehicle Wrap Shop','汽车美容店':'Auto Detailing Shop','其他':'Other',
    'Google 搜集':'Google Research','Yelp 搜集':'Yelp Research','业务员发现':'Sales Discovery','客户介绍':'Customer Referral',
    '新增客户时不安排拜访时间，保存后再到“计划拜访”选择。':'Save the customer first, then schedule the visit from Plan Visits.',
    '定位已取得，请确认并填写完整门牌地址。':'Location captured. Please verify and enter the complete street address.',
    '分钟':'minutes','保存后将进入“今日拜访”，出发时重新使用地图更新实时路况。':'After saving, the route appears under Today’s Visits. Refresh the map when departing for current traffic.',
    '待出发':'Not Started','前往中':'En Route','拜访中':'In Progress','已完成':'Completed','已取消':'Canceled',
    '订单号':'Order Number','业务员 · 可选可填':'Sales Representative · Optional','订单类型 · 可选可填':'Order Type · Optional','出货仓库 · 可选可填':'Fulfillment Warehouse · Optional',
    '批发订单':'Wholesale Order','洛杉矶仓':'Los Angeles Warehouse','拉斯维加斯仓':'Las Vegas Warehouse','订单产品':'Order Products','＋ 选择或输入产品':'＋ Select or Enter Product',
    '产品型号':'Product Model','系统产品库':'Product Catalog','数量':'Quantity','折扣':'Discount','交付与付款':'Delivery and Payment','交付方式 · 可选可填':'Delivery Method · Optional',
    '现场交货':'On-site Delivery','仓库自提':'Warehouse Pickup','快递配送':'Carrier Shipping','交付日期':'Delivery Date','信用卡':'Credit Card','现金':'Cash','支票':'Check',
    '税务状态':'Tax Status','批发免税':'Wholesale Tax Exempt','应税':'Taxable','订单备注':'Order Notes','补充配送、价格或客户要求……':'Add delivery, pricing, or customer requirements…',
    '订单金额':'Order Amount','产品小计':'Product Subtotal','订单折扣':'Order Discount','销售税':'Sales Tax','订单总额':'Order Total','已收':'Paid','欠款':'Balance Due','产品':'Products','卷':'rolls',
    '创建订单并进入客户签收':'Create Order and Continue to Acceptance','创建后自动生成库存出库、收款记录和客户应收账款。':'Saving creates inventory, payment, and customer receivable records.',
    '到店拜访':'On-site Visit','电话跟进':'Phone Follow-up','邮件跟进':'Email Follow-up','样品测试回访':'Sample Trial Follow-up','收款跟进':'Payment Follow-up','报价跟进':'Quote Follow-up',
    '到店打卡':'Arrival Check-in','下一步':'Next Step','今日完成 ':'Completed ',' 家客户拜访，现场订单 ':' customer visits, on-site orders ','，收款 ':'; payments ','，已建立 ':'; created ',' 项后续跟进。':' follow-up tasks.',
    '新增客户':'New Customers','客户问题／需要公司协助':'Customer Issues / Support Needed'
  };
  const translate = text => Object.entries(phrases)
  ...
  return String(html).split(/(<[^>]*>)/g).map(part => {
    ...
    return part.replace(/\b(placeholder|aria-label)="([^"]*)"/g, (_, attr, value) => `${attr}="${translate(value)}"`);
  }).join('');
}
...
function salesCustomerMiniCard(account, selectMode = false) {
  ...
  const type = account.customerType || account.stage || (lang === 'en' ? 'Customer' : '客户');
  const contact = account.contactName ? `${lang === 'en' ? 'Contact: ' : '联系人：'}${escapeHtml(account.contactName)}` : (lang === 'en' ? 'No contact entered' : '尚未填写联系人');
  return `<article class="sales-customer-mini ${selected ? 'selected' : ''}"><div class="sales-customer-icon">🏪</div><div><b>${escapeHtml(account.businessName)}</b><p>${escapeHtml(account.address || '')}</p><small>${escapeHtml(type)} · ${contact}${distance !== null ? ` · ${distance.toFixed(1)} mi` : ''}</small></div><div class="sales-card-actions"><button onclick="openSalesReviewDialog('${account.id}')">查看资料</button><button class="primary-inline" onclick="${selectMode ? `toggleSalesPlanAccount('${account.id}')` : `quickPlanSalesAccount('${account.id}')`}">${selectMode ? (selected ? '已选择' : '选择') : '加入拜访计划'}</button></div></article>`;
}
...
function salesAddCustomerHtml() {
  return salesPage('新增客户', `<section class="sales-ai-import"><b>📷 拍照，AI 自动识别</b><span>识别店名、地址、电话和邮箱，并自动填入下方</span><input type="file" accept="image/*" capture onchange="analyzeSalesCustomerScreenshot(this)"></section><section class="sales-form-card"><div class="sales-section-title"><b>客户基本资料</b><span>也可以手动填写</span></div><label>客户或门店名称 *<input id="salesBusinessName"></label><label>客户地址 *<textarea id="salesAddress"></textarea></label><label>现场定位<button type="button" class="sales-location-button" onclick="fillSalesCurrentLocation()">📍 已到客户门口？获取当前位置</button></label><div class="sales-two"><label>城市<input id="salesCity"></label><label>联系电话<input id="salesPhone" type="tel"></label></div><label>电子邮箱<input id="salesEmail" type="email"></label><div class="sales-two"><label>客户类型<select id="salesCustomerType"><option value="贴膜门店">贴膜门店</option><option value="汽车改色店">汽车改色店</option><option value="汽车美容店">汽车美容店</option><option value="其他">其他</option></select></label><label>客户来源<select id="salesSource"><option value="Google 搜集">Google 搜集</option><option value="Yelp 搜集">Yelp 搜集</option><option value="业务员发现">业务员发现</option><option value="客户介绍">客户介绍</option></select></label></div><label>联系人<input id="salesContact"></label><label>客户备注<textarea id="salesNote"></textarea></label></section><button class="sales-page-primary" onclick="createSalesAccountFromPage(this)">保存到客户列表</button><p class="sales-page-note">新增客户时不安排拜访时间，保存后再到“计划拜访”选择。</p>`);
}

async function fillSalesCurrentLocation() {
  try { const p=await getPosition(); salesNearbyOrigin={lat:p.coords.latitude,lng:p.coords.longitude}; alert(lang === 'en' ? 'Location captured. Please confirm and enter the complete street address.' : '定位已取得，请确认并填写完整门牌地址。'); } catch(e) { alert(e.message || t('locationFailed')); }
}
...
function salesActiveContext(){const sales=state.fieldSales||{};const account=(sales.accounts||[]).find(x=>x.id===salesActiveAccountId);const visit=(sales.visits||[]).find(x=>x.accountId===salesActiveAccountId&&x.userId===user?.id&&x.status==='进行中');const trip=(sales.trips||[]).find(x=>x.accountId===salesActiveAccountId&&x.userId===user?.id);return{sales,account,visit,trip};}
function salesConfirmedProductOptions(){return (state.fieldSales?.products||[]).map(item=>`<option value="${escapeHtml(item.sku)}">${escapeHtml(item.name||item.sku)}</option>`).join('');}
function salesConsignmentPageHtml(account,visit,head){return salesPage('样品 / 放货',`${head}<div class="sales-choice-tabs"><button>免费样品</button><button class="active">试用放货</button></div><div class="sales-linked-data"><b>⛓ 关联正式产品、库存和客户应收</b><span>每项产品和金额都会独立保存为系统数据</span></div><section class="sales-tool-card"><h3>产品明细 <button type="button" onclick="addSalesTrialRow()">＋ 添加产品</button></h3>${salesProductDatalist()}<div id="salesTrialRows">${salesTrialRowHtml({productSku:'QD15-BLK-15218',quantity:2,singlePrice:350})}${salesTrialRowHtml({productSku:'QD35-SAMPLE',quantity:5,singlePrice:0})}</div></section><section class="sales-tool-card"><h3>试用与收款约定</h3><div class="sales-two"><label>出货仓库<input id="salesConsignWarehouse" value="洛杉矶业务车库存"></label><label>收款状态<select id="salesConsignStatus"><option>部分收款</option><option>未收款</option><option>已付清</option></select></label></div><div class="sales-two"><label>试用截止日期<input id="salesTrialFollowUp" type="date" value="${salesLocalDate(7)}"></label><label>预计收款日期<input id="salesPaymentDueAt" type="date" value="${salesLocalDate(8)}"></label></div><div class="sales-two"><label>本次已收金额<input id="salesAmountPaid" type="number" value="100"></label><label>付款方式<input id="salesConsignPayment" value="现金"></label></div><label>补充备注<textarea id="salesConsignNote" placeholder="记录特殊价格、退换条件或其他约定……"></textarea></label></section><section class="sales-tool-card"><h3>放货凭证</h3><label class="sales-proof-upload">📷<span><b>拍摄货物留店照片</b><small>照片保存时间、GPS 位置和产品信息</small></span><input id="salesEvidencePhotos" type="file" accept="image/*" capture="environment" multiple></label></section><div class="sales-money-summary"><p><span>货品总额</span><b>$700</b></p><p><span>本次已收</span><b>$100</b></p><p><span>客户欠款</span><b>$600</b></p></div><p class="sales-page-note">保存后自动生成库存出库、客户欠款和预计收款任务。</p><button class="sales-page-primary" onclick="openSalesVisitScreen('signature')">保存并进入客户签收</button>`);}
function salesOrderPageHtml(account,visit,head){const products=state.fieldSales?.products||[];const p1=products[0]||{sku:'QD15-BLK-15218',name:'QD15 陶瓷隔热膜'};return salesPage('现场订单',`${head}<section class="sales-order-data"><label>订单号<input readonly placeholder="保存后自动生成"></label><label>业务员 · 可选可填<input value="${escapeHtml(user?.name||'')}"></label><label>订单类型<select id="salesOrderType"><option value="批发订单">批发订单</option></select></label><label>出货仓库<select id="salesOrderWarehouse"><option value="洛杉矶仓">洛杉矶仓</option><option value="拉斯维加斯仓">拉斯维加斯仓</option></select></label></section><section class="sales-tool-card"><h3>订单产品 <button type="button">＋ 选择或输入产品</button></h3>${salesProductDatalist()}<article class="sales-order-product"><label>产品型号<input id="salesOrderSku" list="salesProductModels" value="${escapeHtml(p1.sku||'')}"></label><small>${escapeHtml(p1.name||p1.sku||'')} · 系统产品库</small><div class="sales-order-values"><label>数量<input id="salesOrderQty" type="number" value="6"></label><label>成交单价<input id="salesOrderPrice" type="number" value="340"></label><label>折扣<input id="salesOrderDiscount" type="number" value="60"></label></div></article></section><section class="sales-tool-card"><h3>交付与付款</h3><div class="sales-two"><label>交付方式<select id="salesDeliveryMethod"><option value="现场交货">现场交货</option><option value="仓库自提">仓库自提</option><option value="快递配送">快递配送</option></select></label><label>交付日期<input type="date" value="${salesLocalDate()}"></label></div><div class="sales-two"><label>本次已收<input id="salesOrderPaid" type="number" value="1000"></label><label>付款方式<select id="salesOrderPayment"><option value="信用卡">信用卡</option><option value="现金">现金</option><option value="支票">支票</option></select></label></div><div class="sales-two"><label>余款到期日<input id="salesOrderDue" type="date" value="${salesLocalDate(8)}"></label><label>税务状态<select id="salesOrderTax"><option value="批发免税">批发免税</option><option value="应税">应税</option></select></label></div><label>订单备注<textarea id="salesOrderNote" placeholder="补充配送、价格或客户要求……"></textarea></label></section><section class="sales-tool-card"><h3>订单金额</h3><div class="sales-order-total"><p>产品小计 <b>$2,040.00</b></p><p>订单折扣 <b>− $60.00</b></p><p>销售税 <b>$0.00</b></p><p>订单总额 <b>$1,980.00</b></p></div><div class="sales-receipt-totals"><p>已收<b>$1,000</b></p><p>欠款<b>$980</b></p><p>产品<b>6 卷</b></p></div></section><button class="sales-page-primary" onclick="saveSalesFieldOrder(this,'${account.id}','${visit?.id||''}')">创建订单并进入客户签收</button><p class="sales-page-note">创建后自动生成库存出库、收款记录和客户应收账款。</p>`);}
function salesExecutionHtml(){const {account,visit,trip}=salesActiveContext();if(!account)return salesTodayHtml();const items=[['📷','现场照片','门店、样品和陈列照片','photos'],['◉','沟通记录','录音转文字并由 AI 总结','conversation'],['▦','样品 / 放货','记录型号、数量和约定价格','consignment'],['＋','现场订单','直接建立客户销售订单','order'],['✎','客户签收','英文签收单和手写签名','signature'],['⌚','下次跟进','设置日期、原因和收款提醒','followup']];return salesPage('拜访执行', `<section class="sales-next-card"><small>已到店</small><h3>${escapeHtml(account.businessName)}</h3><p>${escapeHtml(account.address)}</p><div class="sales-trip-stats"><span>出发<b>${trip?.departedAt?formatMobileDateTime(trip.departedAt):'—'}</b></span><span>到达<b>${visit?.startedAt?formatMobileDateTime(visit.startedAt):'—'}</b></span></div></section><section class="sales-check-ok">✓ 到店打卡已完成<br><small>GPS 位置与客户地址匹配 · 门头照片已上传</small></section><div class="sales-execution-grid">${items.map(([icon,title,sub,screen])=>`<button onclick="openSalesVisitScreen('${screen}')"><i>${icon}</i><b>${title}</b><span>${sub}</span></button>`).join('')}</div><button class="sales-page-primary" onclick="openSalesVisitScreen('complete')">完成本次拜访</button>`);}

function salesVisitToolHtml(screen){const {account,visit}=salesActiveContext();if(!account)return salesTodayHtml();const head=`<section class="sales-tool-customer"><h2>${escapeHtml(account.businessName)}</h2><span>本次拜访 · ${visit?.startedAt?new Date(visit.startedAt).toLocaleTimeString([],{hour:'2-digit',minute:'2-digit'}):'已到店'}</span></section>`;
  if(screen==='photos')return salesPage('现场照片',`${head}<section class="sales-tool-card"><h3>🏪 门头照片 <em>必拍</em></h3><p>证明业务员已到达客户门店</p><label class="sales-photo-slot">＋<b>继续拍照</b><input type="file" accept="image/*" capture="environment"></label><div class="sales-tool-ok">✓ 照片时间和现场 GPS 位置已保存</div></section><section class="sales-tool-card"><h3>▣ 店内环境 <em>选填</em></h3><p>记录门店规模、施工区和陈列情况</p><label class="sales-photo-slot">＋<b>拍摄店内</b><input type="file" accept="image/*" capture="environment"></label></section><section class="sales-tool-card"><h3>▥ 产品 / 样品 <em>选填</em></h3><p>记录展示样品及客户感兴趣的产品</p><label class="sales-photo-slot">＋<b>添加照片</b><input type="file" accept="image/*" capture="environment"></label></section><button class="sales-page-primary" onclick="openSalesVisitScreen('execution')">保存照片并返回拜访</button>`);
  if(screen==='conversation')return salesPage('沟通记录',`${head}<section class="sales-talk-recorder"><div><strong>现场会议纪要</strong><b>00:00</b></div><label class="sales-talk-wave">▂▅▃▇▅▆▂▆▃▇▅▃<input type="file" accept="audio/*" capture onchange="transcribeSalesVisitAudio(this)"></label><div><button>▶ 回顾会议</button><button class="primary-inline">＋ 继续记录</button></div></section><section class="sales-tool-card"><h3>会议文字记录 <em>自动转写</em></h3><textarea id="salesReportText" placeholder="录音后自动生成会议文字记录"></textarea></section><section class="sales-tool-card"><h3>AI 中文分析 <em>可修改</em></h3><div class="sales-ai-analysis"><label>客户需求<textarea placeholder="客户希望测试的产品和采购需求"></textarea></label><label>本次结果<textarea placeholder="本次沟通达成的结果"></textarea></label><label>价格反馈<textarea placeholder="价格接受程度和反馈"></textarea></label><label>客户异议<textarea placeholder="客户关注和异议"></textarea></label><label>下一步<textarea placeholder="后续行动计划"></textarea></label></div></section><section class="sales-tool-card"><h3>人工补充 <em>选填</em></h3><textarea placeholder="补充会议中需要记录的重要信息……"></textarea></section><button class="sales-page-primary" onclick="openSalesVisitScreen('execution')">确认并保存沟通记录</button>`);
  if(screen==='consignment')return salesConsignmentPageHtml(account,visit,head);
  if(screen==='order')return salesOrderPageHtml(account,visit,head);
  if(screen==='signature'){const order=(state.fieldSales?.fieldOrders||[]).find(x=>x.accountId===account.id);const total=Number(order?.total||0),paid=Number(order?.amountPaid||0),balance=Math.max(0,total-paid);return salesPage('客户签收',`${head}<section class="sales-tool-card"><h3>Delivery Receipt <em>English</em></h3><div class="sales-receipt-lines"><p><span>Order Number</span><b>${escapeHtml(order?.orderNumber||'保存订单后自动生成')}</b></p><p><span>Delivery Date</span><b>${new Date().toLocaleDateString('en-US')}</b></p><p><span>Sales Representative</span><b>${escapeHtml(user?.name||'')}</b></p><p><span>Delivery Location</span><b>${escapeHtml(account.businessName)}</b></p></div></section><section class="sales-tool-card"><h3>Products Received <em>${(order?.items||[]).reduce((s,x)=>s+Number(x.quantity||0),0)} rolls</em></h3><div class="sales-received-products">${(order?.items||[]).map(x=>`<p><b>${escapeHtml(x.sku||x.name||'Product')}</b><span>${Number(x.quantity||0)} rolls</span><span>$${Number(x.total||Number(x.quantity||0)*Number(x.unitPrice||0)).toLocaleString()}</span></p>`).join('')||'<p><b>Products from current visit</b></p>'}</div><div class="sales-receipt-totals"><p>Total<b>$${total.toLocaleString()}</b></p><p>Paid<b>$${paid.toLocaleString()}</b></p><p>Balance<b>$${balance.toLocaleString()}</b></p></div></section><section class="sales-tool-card"><h3>Customer Confirmation</h3><label class="sales-confirm-line"><input type="checkbox" checked> I confirm that the products and quantities listed above have been received in good condition.</label><label class="sales-confirm-line"><input type="checkbox" checked> I acknowledge the remaining balance shown above.</label></section><section class="sales-tool-card"><h3>Customer Signature <em>Required</em></h3><div class="sales-two"><label>Printed Name<input id="salesSignedBy"></label><label>Title<input id="salesSignerTitle"></label></div><canvas id="salesCustomerSignature" width="600" height="220"></canvas><button onclick="clearSalesSignature()">Clear Signature</button></section><button class="sales-page-primary">确认签收并生成英文签收单</button><p class="sales-page-note">签名、签收时间、GPS 位置、产品和欠款信息将一并保存。</p>`);}
  if(screen==='followup')return salesPage('下次跟进',`${head}<section class="sales-form-card"><label>跟进方式<select><option value="到店拜访">到店拜访</option><option value="电话跟进">电话跟进</option><option value="邮件跟进">邮件跟进</option></select></label><label>任务类型<select><option value="样品测试回访">样品测试回访</option><option value="收款跟进">收款跟进</option><option value="报价跟进">报价跟进</option></select></label><label>跟进时间<input type="datetime-local" value="${localDateTimeValue(new Date(Date.now()+7*86400000).toISOString())}"></label><label>跟进原因<textarea></textarea></label></section><button class="sales-page-primary" onclick="openSalesFollowUp('${account.id}')">保存跟进任务</button>`);
  return salesPage('完成拜访',`${head}<section class="sales-complete-summary"><h3>资料完成情况 <b>全部完成</b></h3><div>${['到店打卡','现场照片','会议纪要','样品 / 放货','现场订单','客户签收','下次跟进','收款提醒'].map(x=>`<p><i>✓</i><span>${x}</span></p>`).join('')}</div></section><section class="sales-tool-card"><h3>AI 拜访总结</h3><textarea id="salesReportText" placeholder="AI 总结可修改"></textarea></section><button class="sales-page-primary" onclick="openSalesCompleteDialog('${visit?.id||''}')">完成拜访并前往下一家</button>`);
}

function openSalesFollowUp(accountId){const overlay=document.createElement('div');overlay.className='mobile-modal';overlay.innerHTML=salesLocalizedHtml(`<div class="mobile-dialog"><div class="dialog-head"><strong>下次跟进</strong><button onclick="this.closest('.mobile-modal').remove()">×</button></div><label>跟进方式<select id="salesFollowMethod"><option value="到店拜访">到店拜访</option><option value="电话跟进">电话跟进</option><option value="邮件跟进">邮件跟进</option></select></label><label>任务类型<select id="salesFollowType"><option value="样品测试回访">样品测试回访</option><option value="收款跟进">收款跟进</option><option value="报价跟进">报价跟进</option></select></label><label>跟进时间<input id="salesFollowDue" type="datetime-local" value="${localDateTimeValue(new Date(Date.now()+7*86400000).toISOString())}"></label><label>跟进原因<textarea id="salesFollowReason"></textarea></label><div class="dialog-actions"><button onclick="this.closest('.mobile-modal').remove()">取消</button><button class="primary" onclick="saveSalesFollowUp(this,'${accountId}')">保存跟进任务</button></div></div>`);document.body.appendChild(overlay);}
...
function salesReportHtml(){const today=salesLocalDate();const sales=state.fieldSales||{};const visits=(sales.visits||[]).filter(v=>v.userId===user?.id&&v.status==='已完成'&&String(v.completedAt||'').slice(0,10)===today);const trials=(sales.trialRolls||[]).filter(x=>x.userId===user?.id&&String(x.createdAt||'').slice(0,10)===today);const orders=(sales.fieldOrders||[]).filter(x=>x.userId===user?.id&&String(x.createdAt||'').slice(0,10)===today);const follow=(sales.followUps||[]).filter(x=>x.userId===user?.id&&String(x.createdAt||'').slice(0,10)===today);const total=orders.reduce((s,o)=>s+Number(o.total||0),0);const paid=orders.reduce((s,o)=>s+Number(o.amountPaid||0),0);const added=(sales.accounts||[]).filter(x=>x.createdByUserId===user?.id&&String(x.createdAt||'').slice(0,10)===today).length;const unit=lang==='en'?'customers':'家';const taskUnit=lang==='en'?'tasks':'项';const summary=lang==='en'?`Completed ${visits.length} customer visits today, with $${total.toLocaleString()} in on-site orders, $${paid.toLocaleString()} collected, and ${follow.length} follow-up tasks created.`:`今日完成 ${visits.length} 家客户拜访，现场订单 $${total.toLocaleString()}，收款 $${paid.toLocaleString()}，已建立 ${follow.length} 项后续跟进。`;return salesPage('工作日报', `<section class="sales-report-hero"><small>今日工作总结</small><h3>${today} · ${escapeHtml(user?.name||'')}</h3><b>${visits.length} ${unit}</b></section><section class="sales-auto-summary"><div><i>＋</i><span>新增客户</span><b>${added} ${unit}</b></div><div><i>⌖</i><span>客户拜访</span><b>${visits.length} ${unit}</b></div><div><i>▦</i><span>样品 / 放货</span><b>${trials.reduce((s,x)=>s+Number(x.quantity||0),0)}</b></div><div><i>＄</i><span>现场订单</span><b>$${total.toLocaleString()}</b></div><div><i>✓</i><span>今日收款</span><b>$${paid.toLocaleString()}</b></div><div><i>⌚</i><span>新增跟进任务</span><b>${follow.length} ${taskUnit}</b></div></section><section class="sales-form-card"><label>AI 工作总结<textarea id="salesDailySummary">${escapeHtml(summary)}</textarea></label><label>客户问题／需要公司协助<textarea id="salesDailyBlockers"></textarea></label><label>人工补充<textarea id="salesDailyPlan"></textarea></label></section><button class="sales-page-primary" onclick="submitSalesDailyReport(this)">确认并提交今日工作日报</button><p class="sales-page-note">所有数字来自当天正式业务记录，AI 只负责整理总结。</p>`);}

function salesHtml() {
  const sales=state.fieldSales||{};
  if(!sales.enabled)return salesLocalizedHtml(`<div class="panel"><div class="panel-body hint">当前账号没有业务员管理权限。</div></div>`);
  ...
  if(['photos','conversation','consignment','order','signature','followup','complete'].includes(salesScreen))return salesVisitToolHtml(salesScreen);
