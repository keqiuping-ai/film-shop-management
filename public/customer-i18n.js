(function () {
  ...
  const rows = [
    ...
    ['SEARCH OTHER IN-STOCK PPF MODELS','その他の在庫ありPPF型番を検索','다른 재고 보유 PPF 모델 검색','BUSCAR OTROS MODELOS PPF EN INVENTARIO','搜索其他车衣库存型号'],
    ['Example: G18, G20PLUS, DS13S','例：G18、G20PLUS、DS13S','예: G18, G20PLUS, DS13S','Ej.: G18, G20PLUS, DS13S','例如：G18、G20PLUS、DS13S'],
    ['Only purchasable PPF currently in stock is shown. Pricing uses the signed-in customer agreement or dealer tier.','現在購入可能で在庫のあるPPFのみ表示します。価格はログイン中のお客様の契約価格またはランク価格です。','현재 구매 가능하고 재고가 있는 PPF만 표시합니다. 가격은 로그인한 고객의 계약가 또는 등급가를 적용합니다.','Solo muestra PPF disponible y con inventario. El precio corresponde al acuerdo o nivel del cliente conectado.','只显示当前可购买且有库存的车衣；价格按当前登录客户的协议价或等级价结算。'],
    ['SEARCH OTHER IN-STOCK COLOR-WRAP MODELS','その他の在庫ありカーラップ型番を検索','다른 재고 보유 컬러 랩 모델 검색','BUSCAR OTROS MODELOS DE VINILO EN INVENTARIO','搜索其他改色膜库存型号'],
    ['Example: TPUQD42, QD111','例：TPUQD42、QD111','예: TPUQD42, QD111','Ej.: TPUQD42, QD111','例如：TPUQD42、QD111'],
    ['Only purchasable color wrap currently in stock is shown. Pricing uses the signed-in customer agreement or dealer tier.','現在購入可能で在庫のあるカーラップのみ表示します。価格はログイン中のお客様の契約価格またはランク価格です。','현재 구매 가능하고 재고가 있는 컬러 랩만 표시합니다. 가격은 로그인한 고객의 계약가 또는 등급가를 적용합니다.','Solo muestra vinilo de cambio de color disponible y con inventario. El precio corresponde al acuerdo o nivel del cliente conectado.','只显示当前可购买且有库存的改色膜；价格按当前登录客户的协议价或等级价结算。'],
    ['Select an inventory model','在庫型番を選択','재고 모델 선택','SELECCIONE UN MODELO DE INVENTARIO','请选择一个库存型号'],
    ['Model, size, and customer price appear automatically','型番、サイズ、お客様価格が自動表示されます','모델, 규격 및 고객 가격이 자동으로 표시됩니다','El modelo, tamaño y precio del cliente aparecen automáticamente','型号、规格和客户价格将自动带入这里'],
    ['Model, color name, size, and customer price appear automatically.','型番、色名、サイズ、お客様価格が自動表示されます。','모델, 색상명, 규격 및 고객 가격이 자동으로 표시됩니다.','El modelo, color, tamaño y precio del cliente aparecen automáticamente.','输入仓库型号，选择搜索结果后自动带入颜色名称、规格和客户价格。'],
    ['Filled after model selection','型番選択後に自動入力','모델 선택 후 자동 입력','SE COMPLETA AL ELEGIR EL MODELO','选择型号后自动带入'],
    ['Selected automatically','選択後に自動入力','선택 후 자동 입력','SE COMPLETA AL SELECCIONAR','选择后自动带入'],
  ...
  const chineseEnglish = new Map(Object.entries({
    ...
    ,'快速选货与下单':'QUICK SELECT & ORDER','搜索其他库存型号':'SEARCH OTHER INVENTORY MODELS','例如：A18、A20、A17':'Example: A18, A20, A17','只显示当前可购买且有库存的窗膜；价格按当前登录客户的协议价或等级价结算。':'Only purchasable window film currently in stock is shown. Pricing uses the signed-in customer agreement or dealer tier.','搜索其他车衣库存型号':'SEARCH OTHER IN-STOCK PPF MODELS','例如：G18、G20PLUS、DS13S':'Example: G18, G20PLUS, DS13S','只显示当前可购买且有库存的车衣；价格按当前登录客户的协议价或等级价结算。':'Only purchasable PPF currently in stock is shown. Pricing uses the signed-in customer agreement or dealer tier.','搜索其他改色膜库存型号':'SEARCH OTHER IN-STOCK COLOR-WRAP MODELS','例如：TPUQD42、QD111':'Example: TPUQD42, QD111','只显示当前可购买且有库存的改色膜；价格按当前登录客户的协议价或等级价结算。':'Only purchasable color wrap currently in stock is shown. Pricing uses the signed-in customer agreement or dealer tier.','请选择一个库存型号':'SELECT AN INVENTORY MODEL','型号、规格和客户价格将自动带入这里':'MODEL, SIZE, AND CUSTOMER PRICE APPEAR AUTOMATICALLY','输入仓库型号，选择搜索结果后自动带入颜色名称、规格和客户价格。':'Enter a warehouse model, then choose a result to fill in the color name, size, and customer price.','选择型号后自动带入':'FILLED AFTER MODEL SELECTION','选择后自动带入':'FILLED AFTER SELECTION','请先选择上方型号':'SELECT A MODEL ABOVE','型号参数将自动带入这里':'MODEL DETAILS APPEAR AUTOMATICALLY','卷材规格':'ROLL SIZE'
